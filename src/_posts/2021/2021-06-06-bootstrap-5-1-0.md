...
The first minor release of Bootstrap 5 is here! v5.1.0 has arrived and is packed to the brim with some exciting new features and improvements. There's support for CSS Grid, offcanvas in the navbar, a new placeholders component, horizontal collapse support, some new helpers, CSS variables in our utilities, refactored JavaScript, and more.
...
- Shipped a major cleanup to our collapse plugin
- Added scrollspy support to our table of contents in the docs
- Updated
-
